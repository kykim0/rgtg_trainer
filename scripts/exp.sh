...
LEVEL1="iter${ITER}_${LEARNING_RATE}_beta${BETA}_${OPTIM}_rgtg${RGTG_WEIGHT}_${LOSS_TYPE}_acc${ACCUMULATE}_reward_nolength_adaptweight"
LEVEL2="${LOSS_TYPE}_${PREF}"

OUTPUT_DIR="checkpoints/${LEVEL1}/${LEVEL2}"
log_file="iter${ITER}_${LEARNING_RATE}_${BETA}_${OPTIM}_${LOSS_TYPE}_${PREF}_rgtg${RGTG_WEIGHT}_acc${ACCUMULATE}_reward_nolength_adaptweight"
...
accelerate launch \
    ...
    --main_process_port 1930 \
    --num_processes 2 \
    rgtg/run_trainer.py "$new_config_file" \
